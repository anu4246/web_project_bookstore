            ...
            <form class="flip-forms signIn custom-bg-white p-4 m-4 rounded-lg max-w-screen w-80 sm:w-96" method="post">
                ...
                <div class="grid">
                    <div class="my-4">
                        ...
                        <input class="login-inp shadow px-4 py-3 w-full rounded-lg mt-1 border hover:border-black focus:border-black" type="text" placeholder="eg - walid@gmail.com" name="email">
                    </div>
                    <div class="">
                        <div class="flex items-center justify-between">
                        ...
                        <div class="bg-white shadow rounded-lg px-4 mt-1 border hover:border-black focus:border-black flex items-center">
                            <input class="login-inp py-3 w-full rounded-lg outline-none" type="password" placeholder="pass123#" name="pwd">
            ...
            <form class="hidden flip-forms signup custom-bg-white p-4 m-4 rounded-lg max-w-screen w-80 sm:w-96" method="post" enctype="multipart/form-data">
                ...
                <div class="all-inputs grid">
                    ...
                    <div class="mt-3 mb-2">
                        ...
                        <input class="shadow px-4 py-3 w-full rounded-lg mt-1 border hover:border-black focus:border-black capitalize" type="text" placeholder="hi walid" name="f-name">
                    </div>
                    <div class="my-2">
                        <p class="text-gray-500 capitalize">email address</p>
                        <input class="shadow px-4 py-3 w-full rounded-lg mt-1 border hover:border-black focus:border-black" type="email" placeholder="walid@gmail.com" name="email">
                    </div>
                    <div class="my-2">
                    ...
                    <div class="my-2">
                        <p class="text-gray-500 capitalize">password</p>
                        <div class="bg-white shadow rounded-lg px-4 mt-1 border hover:border-black focus:border-black flex items-center">
                            <input class="c-pwd py-3 w-full rounded-lg outline-none" type="password" placeholder="pass123#" name="pwd">
                    ...
                    <div class="my-2">
                        ...
                        <div class="bg-white shadow rounded-lg px-4 mt-1 border hover:border-black focus:border-black flex items-center">
                            <input class="c-pwd py-3 w-full rounded-lg outline-none" type="password" placeholder="pass123#" name="c-pwd">
                            <i class="show-pwd cursor-default sm:cursor-pointer" data-feather="eye"></i>
                        </div>
