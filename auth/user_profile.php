        ...
        <?php
            ...
            if($result)
            {
                ...
                <div class="grid place-items-center my-4">
                    ...
                    <p class="username text-gray-500">@walid123</p>
            </div>
                    ';
            }
        ?>
        ...
        <div class="bg-white p-4 rounded-lg my-4">
            ...
            <?php
                ...
                <div class="flex items-center gap-1 mt-4 border rounded-lg px-1">
                    ...
                    <input id="userName" class="capitalize py-3 outline-none w-full font-semibold" value="@walid123"/>
                </div>
                <div class="flex items-center gap-1 mt-4 border rounded-lg px-1">
...
<!--  -->
        <div class="bg-white p-4 rounded-lg my-4">
            ...
            <div class="flex items-center gap-1 mt-4 border rounded-lg px-1">
                ...
                <input id="fullName" class="capitalize py-3 outline-none w-full font-semibold" value="Walid Hassan Khan"/>
            </div>
            <div class="flex items-center gap-1 mt-4 border rounded-lg px-1">
            ...
            <div class="flex items-center gap-1 mt-4 border rounded-lg px-1">
                ...
                <input id="email" class="py-3 outline-none w-full font-semibold" value="walid1@gmail.com"/>
            </div>
            </div>
            <div class="md:flex items-center gap-4 justify-center">
